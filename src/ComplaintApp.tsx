  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .hjs-mod .board { display: grid; grid-template-columns: repeat(4,minmax(0,1fr)); gap: 12px; align-items: start; }
      ...
      .hjs-mod .column:nth-child(4) { border-top: 3px solid ${T.green}; }
      ...
      @media (max-width: 1400px) { .hjs-mod .board { grid-template-columns: repeat(2,minmax(0,1fr)); gap: 14px; } }
